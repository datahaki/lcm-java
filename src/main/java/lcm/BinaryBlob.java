...
public final class BinaryBlob implements lcm.lcm.LCMEncodable {
  ...
  public static long _hashRecursive(ArrayList<Class<?>> classes) {
    if (classes.contains(lcm.BinaryBlob.class))
      return 0L;
    classes.add(lcm.BinaryBlob.class);
  ...
  public static lcm.BinaryBlob _decodeRecursiveFactory(DataInput ins) throws IOException {
    lcm.BinaryBlob o = new lcm.BinaryBlob();
  ...
  public lcm.BinaryBlob copy() {
    lcm.BinaryBlob outobj = new lcm.BinaryBlob();
